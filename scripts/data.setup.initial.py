...
# - create skeleton traces (no thickness for vessels): still under construction
...
pathPhotos = "../Photos/Raw-photos"
pathTraces = "../Traces/Raw-traces"
pathSkeletons = "../Skeletons"

pathPhotosProcessed = "../Photos/Pre-processed"
pathTracesProcessed = "../Traces/Pre-processed"
